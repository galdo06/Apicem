            ...
            <asp:FormView SkinID="FormView" ID="formViewTlProject" runat="server" DataSourceID="odsProject_Details"
                ...
                <ItemTemplate>
                    ...
                    <div class="grid_10 inline alpha" style="width: 465px;">
                        ...
                        <asp:Label ID="lblCalc" Text='<%# projectInfoTreeLocation == null  || projectInfoTreeLocation.Mitigation == null ? "" : Eisk.BusinessLogicLayer.ProjectInfoTreeLocationBLL.GetTipoDesarrollo(projectInfoTreeLocation.Mitigation ) %>' runat="server" />
                        <br />
                        <strong>Proyecto de Interés Social:</strong>
                        <asp:Label ID="lblSocialInterest" Text='<%# ( projectInfoTreeLocation == null  || projectInfoTreeLocation.SocialInterest == null ? "No" : (projectInfoTreeLocation.SocialInterest ==null || !(bool)projectInfoTreeLocation.SocialInterest ? "No":"Si"))  %>' runat="server" />
                        <br />
                        <strong>Total de Cuerdas en el Proyecto:</strong>
                        <asp:Label ID="Label2" Text='<%# projectInfoTreeLocation == null  || projectInfoTreeLocation.Acres == null ? "0.00" : projectInfoTreeLocation.Acres.ToString() %>' runat="server" />
                        <br />
                        <strong>Estacionamientos:</strong>
                        <asp:Label ID="lblParking" Text='<%# projectInfoTreeLocation == null   || projectInfoTreeLocation.Parkings == null ? 0 : projectInfoTreeLocation.Parkings  %>' runat="server" />
                        <br />
                ...
                <EditItemTemplate>
                    ...
                    <div class="grid_10 inline alpha" style="width: 100%;">
                        ...
                        <asp:RadioButtonList ID="rblCalc" runat="server" RepeatDirection="Vertical" ClientIDMode="Static"
                            Style="margin-bottom: 0px;" SelectedValue='<%# projectInfoTreeLocation == null || projectInfoTreeLocation.Mitigation == null ? "3" : projectInfoTreeLocation.Mitigation.ToString() %>'>
