<%@ Page Title="" Language="C#" MasterPageFile="~/App_Resources/master.master"
    AutoEventWireup="true" Inherits="public_public" Codebehind="public.aspx.cs" %>

<asp:Content ID="Content2" ContentPlaceHolderID="BodyContentPlaceholder" runat="Server">
    <h1 class="title-regular clearfix">
        Sample Public Page</h1>
    <p>
