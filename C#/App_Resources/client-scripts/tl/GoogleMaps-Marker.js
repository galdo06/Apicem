...
function InitializeMarkers(Trees) {
    ...
    for (var i = 0; i < Trees.length; i++) {
        ...
        icon: '../App_Resources/images/icons/' + tree.ColorDesc +'/'+ tree.ColorDesc.toLowerCase() + ' ' + tree.Number + '.png',
...
function setDeleteMarker(projectOrganismID, projectID) {
    ...
    for (var i = 0; i < markerPoints.length; i++) {
        ...
        markerPoints[i].setIcon('../App_Resources/images/icons/' + tree.ColorDesc +'/'+ tree.ColorDesc.toLowerCase() + ' ' + tree.Number + '.png');
